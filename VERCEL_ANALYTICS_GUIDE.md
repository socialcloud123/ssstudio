...
This project uses **React with Vite** and has Vercel Web Analytics already integrated. The implementation can be found in `src/main.jsx`:
...
- **@vercel/analytics@^1.6.1** - For web analytics tracking
- **@vercel/speed-insights@^1.3.1** - For performance monitoring

Both packages are integrated at the root level and automatically track:
- Page views across all routes (using react-router-dom)
- User sessions
- Performance metrics
